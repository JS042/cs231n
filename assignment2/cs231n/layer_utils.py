...
def affine_norm_relu_forward(x,w,b,gamma,beta,bn_param,normalization):
    """Convenience layer that performs an affine transform, batch/layer normalization and ReLU
    Inputs:
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
...
def affine_norm_relu_backward(dout,cache, normalization):
    """Backward pass for the affine-batch/layernorm-relu convenience layer.
    """
