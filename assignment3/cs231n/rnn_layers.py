...
def lstm_step_forward(x, prev_h, prev_c, Wx, Wh, b):
    ...
    cache = (x,prev_h,next_h,prev_c,next_c,i,f,o,g,Wx,Wh)
...
def lstm_step_backward(dnext_h, dnext_c, cache):
    ...
    x,prev_h,next_h,prev_c,next_c,i,f,o,g,Wx,Wh = cache
...
def lstm_backward(dh, cache):
    ...
    for t in reversed(range(T)):
        dx_t, dh0_t, dc, dWx_t, dWh_t, db_t = lstm_step_backward(dh[:,t,:] + dh0_t,dc, cache[t])
